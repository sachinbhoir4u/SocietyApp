...
export default function Dashboard({ navigation }: Props) {
  ...
  const handleLogout = async () => {
    try {
      ...
      Alert.alert('Logout Failed', error || 'Unable to logout. Please try again.');
    }
  };
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Flat: {currentUser?.flatNumber || 'N/A'}</Text>
      </View>
      <View style={styles.cardContainer}>
        <ActionCard
          title="Payments"
        ...
        <ActionCard
          title="Notices"
          icon="bell"
          onPress={() => Alert.alert('Notices screen coming soon!')}
        />
        <ActionCard
          title="Complaints"
          icon="exclamation-circle"
          onPress={() => Alert.alert('Complaints screen coming soon!')}
        />
        <ActionCard
          title="Visitors"
          icon="users"
          onPress={() => Alert.alert('Visitor Management screen coming soon!')}
        />
      </View>
      <TouchableOpacity style={styles.logoutButton} onPress={handleLogout}>
        <FontAwesome name="sign-out" size={20} color="white" style={styles.buttonIcon} />
